! function (e) {
    "use strict";
    var n = function (e, t) {
        var r = /[^\w\-.:]/.test(e) ? new Function(n.arg + ",tmpl", "var _e=tmpl.encode" + n.helper + ",_s='" + e.replace(n.regexp, n.func).replace("// <![CDATA[", "").replace("// ]]>", "") + "';return _s;") : n.cache[e] = n.cache[e] || n(n.load(e));
