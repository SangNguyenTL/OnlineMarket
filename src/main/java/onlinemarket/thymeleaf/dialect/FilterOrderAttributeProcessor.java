...
public class FilterOrderAttributeProcessor extends AbstractAttributeTagProcessor {
    
	private static final String ATTR_NAME = "order";
    private static final int PRECEDENCE = 800;
    
	protected FilterOrderAttributeProcessor(final String dialectPrefix) {
    super(
