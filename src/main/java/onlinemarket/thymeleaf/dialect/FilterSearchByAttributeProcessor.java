...
public class FilterSearchByAttributeProcessor extends AbstractAttributeTagProcessor {
    
	private static final String ATTR_NAME = "filterSearchBy";
    private static final int PRECEDENCE = 800;
    
	protected FilterSearchByAttributeProcessor(final String dialectPrefix) {
    super(
