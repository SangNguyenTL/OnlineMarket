...
public class FilterSizeAttributeProcessor extends AbstractAttributeTagProcessor {
    
	private static final String ATTR_NAME = "filterSize";
    private static final int PRECEDENCE = 800;


    public FilterSizeAttributeProcessor(final String dialectPrefix) {
        super(
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
         ...
         */
        final Integer value = (Integer) expression.execute(context);
