...
public class FilterSearchAttributeProcessor extends AbstractAttributeTagProcessor {
    
	private static final String ATTR_NAME = "filterSearch";
    private static final int PRECEDENCE = 800;
    
	protected FilterSearchAttributeProcessor(final String dialectPrefix) {
    super(
